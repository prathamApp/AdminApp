...
//        checkConnection();
    ...
    private void populateVillages() {
        ...
        if (!villageList.isEmpty()) {
            ...
            ArrayAdapter villageAdapter = new ArrayAdapter(GroupVisitForm.this, android.R.layout.simple_spinner_dropdown_item, VillageName);
        ...
        sp_Village.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int pos, long l) {
                ...
                coachList = AppDatabase.getDatabaseInstance(GroupVisitForm.this).getCoachDao().getCoachByVillageID(vid);
...
//                    VG[i] = AllGroupsInDB.get(i).getGroupId();
        ...
        ArrayAdapter grpAdapter = new ArrayAdapter(GroupVisitForm.this, android.R.layout.simple_spinner_dropdown_item, registeredVGGRPs);
...
//            Toast.makeText(CrlVisitForm.this, "" + selectedVG, Toast.LENGTH_SHORT).show();
    ...
    private void populateGrpWithTheirGrp(final List<String> selectedgrpID, final List<String> selectedgrpName) {
        ...
        ArrayAdapter grpAdapter = new ArrayAdapter(GroupVisitForm.this, android.R.layout.simple_spinner_dropdown_item, registeredGWTGGRPs);
...
//                Toast.makeText(CrlVisitForm.this, "" + selectedGWTG, Toast.LENGTH_SHORT).show();
    ...
    private void populateWorkCrosscheckedGrps(final List<String> selectedGrpID, final List<String> selectedgrpName) {
        ...
        ArrayAdapter grpAdapter = new ArrayAdapter(GroupVisitForm.this, android.R.layout.simple_spinner_dropdown_item, registeredWCCGGRPs);
...
//                Toast.makeText(CrlVisitForm.this, "" + selectedWCCG, Toast.LENGTH_SHORT).show();
    ...
    private void populatePresentCoaches() {
        ...
        ArrayAdapter coachAdapter = new ArrayAdapter(GroupVisitForm.this, android.R.layout.simple_spinner_dropdown_item, registeredPCGRPs);
...
*/
    ...
    public void onSelectedTime(int hourStart, int minuteStart, int hourEnd, int minuteEnd) {
        ...
        try {
            ...
            log.setMethodName("GroupVisitForm" + "_" + "onSelectTime");
            log.setDeviceId("");
...
//                checkConnection();
                ...
                GroupVisit grpVisitObj = new GroupVisit();

                grpVisitObj.GroupVisitID = uniqueVisitID;
                grpVisitObj.VillageID = Integer.parseInt(vid);
                grpVisitObj.DateVisited = date;
                grpVisitObj.GroupIDVisited = selectedVG;
                grpVisitObj.CoachPresentInVillage = selectedPC;
                grpVisitObj.WorkCrosscheckedGroupIDs = selectedWCCG;
                grpVisitObj.PresentStudents = edt_PresentStdCount.getText().toString().trim();
                grpVisitObj.Village = vName;
                grpVisitObj.PresentGroupIDs = selectedGWTG; // Select group with their grp = present grp id
                grpVisitObj.Group = "";
                grpVisitObj.StartTime = startTime;
                ...
                log.setExceptionMessage(e.getMessage());
                log.setExceptionStackTrace(e.getStackTrace().toString());
                log.setMethodName("GroupVisitForm" + "_" + "Submit");
                log.setDeviceId("");
                AppDatabase.getDatabaseInstance(ApplicationController.getInstance()).getLogDao().insertLog(log);
                BackupDatabase.backup(ApplicationController.getInstance());
